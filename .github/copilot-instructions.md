...
The primary delivery target is **iOS** (React Native + Expo); the **Next.js web app** is the secondary surface (dashboard, admin, spectator). Both share `packages/sim-engine` — a zero-dependency TypeScript package.
